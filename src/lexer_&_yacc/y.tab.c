...
static const yytype_int16 yyrline[] =
{
     ...
     118,   126,   132,   138,   143,   151,   165,   175,   183,   187,
     200,   201,   206,   220,   238,   242,   263,   268,   272,   273,
     274,   278,   281,   288,   296,   302,   305,   306,   307,   308,
     309,   310,   314,   318,   322,   323,   335,   350,   359,   361,
     365,   369,   376,   381,   385,   386,   387,   388,   389,   390,
     391,   392,   393,   394,   395,   396,   397,   398,   399,   400,
     402,   403,   404,   406,   407,   409,   410,   411,   413,   418,
     419,   420,   421
};
#endif
...
#line 138 "jucompiler.y"
                                { (yyval.node) = newnode(MethodHeader, NULL); (yyval.node)->line = (yylsp[-3]).first_line; (yyval.node)->col = (yylsp[-3]).first_column;
...
#line 376 "jucompiler.y"
                                               { (yyval.node) = newnode(ParseArgs, NULL); (yyval.node)->line = (yylsp[-6]).first_line; (yyval.node)->col = (yylsp[-6]).first_column; 
...
#line 413 "jucompiler.y"
                           { (yyval.node) = newnode(Length, NULL); (yyval.node)->line = (yylsp[0]).first_line; (yyval.node)->col = (yylsp[0]).first_column; 
